...
public class Sup_rdvController implements Initializable {
    @FXML
    ...
    private void ajouterpatient(ActionEvent event) {
        aj.setOnMouseClicked((MouseEvent aevent) -> {
            rdv p = new rdv(a.getText().toString(),b.getText().toString(),c.getText().toString(),d.getText().toString());
            if(a.getText().equals("")) System.out.println("Le champs a est vide");
            if(b.getText().equals("")) System.out.println("Le champs a est vide");
